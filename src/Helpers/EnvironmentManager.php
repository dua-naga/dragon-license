...
class EnvironmentManager
{
    ...
    public function saveFileClassic(Request $input)
    {
        ...
        try {
            ...
            $message = 'Error saving environment file: ' . $e->getMessage();
        }
    ...
    {
        $results = 'Environment file saved successfully.';
        ...
        $envFileData =
            ...
            'VERSION_NAME=' . session()->get('version_name') . "\n\n" .
            'VERSION_CODE=' . session()->get('version_code') . "\n\n" .
            'PRODUCT_TYPE=' . session()->get('product_type') . "\n\n" .
            'DRAGON_LICENSE_URL=' . dragon_license_url() . "\n" .
            'DRAGON_BUSINESS_ID=' . config('dragon-license.business_id') . "\n\n" .
        ...
        try {
            ...
            $results = 'Error saving environment file: ' . $e->getMessage();
        }
